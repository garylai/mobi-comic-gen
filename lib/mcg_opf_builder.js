...
class MCGOPFBuilder {
    ...
    buildBookAsync() {
        return co(function *(){
            ...
            try {
                ...
                const preparedImageInfos = yield this._prepareImagesAsync();
    ...
    _prepareImagesAsync() {
        return co(function *() {
            ...
            for(var i = 0; i < total; i++) {
                ...
                const promise = this._prepareImageAsync(image, outputImageInfos);;
    ...
    _prepareImageAsync(image, outputImageInfos) {
        return co(function *() {
            var imgs = [];
