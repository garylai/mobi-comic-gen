...
const Events = require('./mcg_opf_builder_events.js');
...
class MCGOPFBuilder extends EventEmitter {
        ...
        return co(function *() {
            ...
            for(var i = 0; i < total; i++) {
                ...
                promises.push(promise.then(function() {
                    prepared++;
                    this.emit(Events.Processed, prepared);
                }.bind(this)));
            }
