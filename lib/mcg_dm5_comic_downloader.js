...
const Events = require('./mcg_dm5_comic_downloader_events.js');

const protocol = 'http';
const host = 'www.dm5.com';

class MCGDM5ComicDownloader extends EventEmitter {
    constructor(bookId) {
        super();
    ...
    getPageImagesAsync() {
        return co(function* (){
            ...
            this.emit(Events.Title, title);
            const imageUrls =  yield this._getPageInfoAsync();
            this.emit(Events.TotalNumberOfPage, imageUrls.length);
            ...
            for(var i = 0; i < imageUrls.length; i++) {
                ...
                const promise = new Promise(function(res, rej) {
                    ...
                    stream.once('finish', function() {
                        downloaded++;
                        this.emit(Events.Downloaded, downloaded);
                        res();
                    }.bind(this));
